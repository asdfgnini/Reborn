/********************************************************************************
** Form generated from reading UI file 'rb_rga.ui'
**
...
public:
    ...
    void setupUi(QMainWindow *RB_RGA)
    {
        if (RB_RGA->objectName().isEmpty())
            RB_RGA->setObjectName("RB_RGA");
        RB_RGA->resize(1027, 373);
        RB_RGA->setStyleSheet(QString::fromUtf8("background-color: rgb(10, 22, 46);"));
        centralwidget = new QWidget(RB_RGA);
...
"}"));
        ...
        sizePolicy1.setHeightForWidth(AMU_Start_spinBox->sizePolicy().hasHeightForWidth());
        AMU_Start_spinBox->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(AMU_Stop_spinBox->sizePolicy().hasHeightForWidth());
        AMU_Stop_spinBox->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(PPamu_Range->sizePolicy().hasHeightForWidth());
        PPamu_Range->setSizePolicy(sizePolicy1);
...
"}"));
        ...
        sizePolicy1.setHeightForWidth(Dwell_Range->sizePolicy().hasHeightForWidth());
        Dwell_Range->setSizePolicy(sizePolicy1);
...
"}"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/prefix1/icon/Lamp_Closed.png"), QSize(), QIcon::Normal, QIcon::Off);
        Emission_pushButton->setIcon(icon);
...
"}"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/icon/EM_Operation.png"), QSize(), QIcon::Normal, QIcon::Off);
        EM_pushButton->setIcon(icon1);
...
"}"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/new/prefix1/icon/Start.png"), QSize(), QIcon::Normal, QIcon::Off);
        Scan_pushButton->setIcon(icon2);
...
"}"));
        ...
        RB_RGA->setCentralWidget(centralwidget);

        retranslateUi(RB_RGA);

        QMetaObject::connectSlotsByName(RB_RGA);
    } // setupUi

    void retranslateUi(QMainWindow *RB_RGA)
    {
        RB_RGA->setWindowTitle(QCoreApplication::translate("RB_RGA", "RB_RGA", nullptr));
        title->setText(QCoreApplication::translate("RB_RGA", "\346\211\253\346\217\217\350\256\276\347\275\256", nullptr));
        label_21->setText(QCoreApplication::translate("RB_RGA", "\350\264\250\350\260\261\350\214\203\345\233\264\357\274\232", nullptr));
        AMU_Start_spinBox->setSuffix(QCoreApplication::translate("RB_RGA", " Amu", nullptr));
        AMU_Start_spinBox->setPrefix(QString());
        label_22->setText(QCoreApplication::translate("RB_RGA", "-", nullptr));
        AMU_Stop_spinBox->setSuffix(QCoreApplication::translate("RB_RGA", " Amu", nullptr));
        AMU_Stop_spinBox->setPrefix(QString());
        label_23->setText(QCoreApplication::translate("RB_RGA", "\345\210\206\350\276\250\347\216\207\357\274\232", nullptr));
        label_24->setText(QCoreApplication::translate("RB_RGA", "\346\211\253\346\217\217\346\227\266\351\227\264\357\274\232", nullptr));
        Emission_pushButton->setText(QString());
        EM_pushButton->setText(QString());
        Scan_pushButton->setText(QCoreApplication::translate("RB_RGA", "\345\274\200\345\247\213\346\211\253\346\217\217", nullptr));
        title_4->setText(QCoreApplication::translate("RB_RGA", "\350\265\267\345\247\213\350\264\250\350\260\261", nullptr));
        Start_AMU_Value->setText(QCoreApplication::translate("RB_RGA", "-", nullptr));
        title_6->setText(QCoreApplication::translate("RB_RGA", "\347\273\210\346\255\242\350\264\250\350\260\261", nullptr));
        Stop_AMU_Value->setText(QCoreApplication::translate("RB_RGA", "-", nullptr));
        title_8->setText(QCoreApplication::translate("RB_RGA", "\345\210\206\350\276\250\347\216\207", nullptr));
        Ppamu_Value->setText(QCoreApplication::translate("RB_RGA", "-", nullptr));
        title_10->setText(QCoreApplication::translate("RB_RGA", "\346\211\253\346\217\217\350\275\256\346\254\241", nullptr));
        Scan_Number_Value->setText(QCoreApplication::translate("RB_RGA", "-", nullptr));
        title_2->setText(QCoreApplication::translate("RB_RGA", "\346\200\273\345\216\213\345\274\272", nullptr));
        Tol_Pressure_Value->setText(QCoreApplication::translate("RB_RGA", "-", nullptr));
    } // retranslateUi

};

namespace Ui {
    class RB_RGA: public Ui_RB_RGA {};
} // namespace Ui
