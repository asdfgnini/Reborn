...
TaoProgressBarStyle::TaoProgressBarStyle(QStyle* style)
{
...
TaoProgressBarStyle::~TaoProgressBarStyle()
{
}

void TaoProgressBarStyle::drawControl(ControlElement element, const QStyleOption* option, QPainter* painter, const QWidget* widget) const
{
    switch (element)
    {
...
QRect TaoProgressBarStyle::subElementRect(SubElement element, const QStyleOption* option, const QWidget* widget) const
{
    switch (element)
    {
