...
TaoSpinBoxStyle::TaoSpinBoxStyle(QStyle* style)
{
...
TaoSpinBoxStyle::~TaoSpinBoxStyle()
{
}

void TaoSpinBoxStyle::drawComplexControl(ComplexControl control, const QStyleOptionComplex* option, QPainter* painter, const QWidget* widget) const
{
    switch (control)
    {
    case QStyle::CC_SpinBox:
    {
        ...
        if (sopt->activeSubControls == SC_ScrollBarAddLine)
        {
            ...
            else
            {
                ...
                {
                    painter->setBrush(TaoThemeColor(_themeMode, BasicBaseDeep));
                }
            }
        }
        else
        ...
        {
            painter->setPen(QPen(TaoThemeColor(_themeMode, PrimaryNormal), 2));
        ...
        {
            painter->setPen(TaoThemeColor(_themeMode, BasicHemline));
...
QRect TaoSpinBoxStyle::subControlRect(ComplexControl cc, const QStyleOptionComplex* opt, SubControl sc, const QWidget* widget) const
{
